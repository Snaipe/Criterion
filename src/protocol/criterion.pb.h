...
typedef enum _criterion_protocol_result_object_result_type {
    criterion_protocol_result_object_result_type_DATA = 1,
    criterion_protocol_result_object_result_type_PATH = 2
} criterion_protocol_result_object_result_type;
...
typedef struct _criterion_protocol_result_object {
    criterion_protocol_result_object_result_type type;
    pb_size_t which_data;
    union {
        pb_bytes_array_t *raw;
        char *str;
    } data;
} criterion_protocol_result_object;

typedef struct _criterion_protocol_result_pair {
    bool has_expected;
    criterion_protocol_result_object expected;
    bool has_actual;
    criterion_protocol_result_object actual;
} criterion_protocol_result_pair;
...
typedef struct _criterion_protocol_result {
    ...
    pb_size_t which_value;
    union {
        criterion_protocol_result_pair obj;
        char *diff;
    } value;
...
#define criterion_protocol_result_object_init_default {(criterion_protocol_result_object_result_type)0, 0, {NULL}}
#define criterion_protocol_result_init_default   {NULL, 0, {criterion_protocol_result_pair_init_default}}
#define criterion_protocol_result_pair_init_default {false, criterion_protocol_result_object_init_default, false, criterion_protocol_result_object_init_default}
...
#define criterion_protocol_result_object_init_zero {(criterion_protocol_result_object_result_type)0, 0, {NULL}}
#define criterion_protocol_result_init_zero      {NULL, 0, {criterion_protocol_result_pair_init_zero}}
#define criterion_protocol_result_pair_init_zero {false, criterion_protocol_result_object_init_zero, false, criterion_protocol_result_object_init_zero}
...
#define criterion_protocol_result_object_raw_tag 2
#define criterion_protocol_result_object_str_tag 3
#define criterion_protocol_result_object_type_tag 1
#define criterion_protocol_result_pair_expected_tag 1
#define criterion_protocol_result_pair_actual_tag 2
...
#define criterion_protocol_result_obj_tag        2
#define criterion_protocol_result_diff_tag       3
...
extern const pb_field_t criterion_protocol_result_object_fields[4];
extern const pb_field_t criterion_protocol_result_fields[4];
extern const pb_field_t criterion_protocol_result_pair_fields[3];
...
#define criterion_protocol_result_pair_size      (12 + criterion_protocol_result_object_size + criterion_protocol_result_object_size)
