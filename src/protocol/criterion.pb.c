...
/* Generated by nanopb-0.3.5-dev at Sun Dec 18 22:52:39 2016. */
...
const pb_field_t criterion_protocol_param_entry_fields[4] = {
    ...
    PB_ONEOF_FIELD(data,   3, STRING  , ONEOF, POINTER , OTHER, criterion_protocol_param_entry, str, name, 0),
    PB_LAST_FIELD
};
...
const pb_field_t criterion_protocol_result_fields[5] = {
    ...
    PB_ONEOF_FIELD(value,   4, STRING  , ONEOF, POINTER , OTHER, criterion_protocol_result, formatted, message, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_assert, results) < 65536 && pb_membersize(criterion_protocol_submessage, value.birth) < 65536 && pb_membersize(criterion_protocol_submessage, value.phase) < 65536 && pb_membersize(criterion_protocol_submessage, value.death) < 65536 && pb_membersize(criterion_protocol_submessage, value.message) < 65536 && pb_membersize(criterion_protocol_submessage, value.assert) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_assert, results) < 65536 && pb_membersize(criterion_protocol_submessage, value.birth) < 65536 && pb_membersize(criterion_protocol_submessage, value.phase) < 65536 && pb_membersize(criterion_protocol_submessage, value.death) < 65536 && pb_membersize(criterion_protocol_submessage, value.message) < 65536 && pb_membersize(criterion_protocol_submessage, value.assert) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_assert, results) < 65536 && pb_membersize(criterion_protocol_submessage, value.birth) < 65536 && pb_membersize(criterion_protocol_submessage, value.phase) < 65536 && pb_membersize(criterion_protocol_submessage, value.death) < 65536 && pb_membersize(criterion_protocol_submessage, value.message) < 65536 && pb_membersize(criterion_protocol_submessage, value.assert) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_param_list, list) < 65536 && pb_membersize(criterion_protocol_result, value.params) < 65536 && pb_membersize(criterion_protocol_assert, results) < 65536 && pb_membersize(criterion_protocol_submessage, value.birth) < 65536 && pb_membersize(criterion_protocol_submessage, value.phase) < 65536 && pb_membersize(criterion_protocol_submessage, value.death) < 65536 && pb_membersize(criterion_protocol_submessage, value.message) < 65536 && pb_membersize(criterion_protocol_submessage, value.assert) < 65536 && pb_membersize(criterion_protocol_msg, data) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_criterion_protocol_birth_criterion_protocol_phase_criterion_protocol_death_criterion_protocol_param_entry_criterion_protocol_param_list_criterion_protocol_result_criterion_protocol_assert_criterion_protocol_log_criterion_protocol_ack_criterion_protocol_submessage_criterion_protocol_msg)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_assert, results) < 256 && pb_membersize(criterion_protocol_submessage, value.birth) < 256 && pb_membersize(criterion_protocol_submessage, value.phase) < 256 && pb_membersize(criterion_protocol_submessage, value.death) < 256 && pb_membersize(criterion_protocol_submessage, value.message) < 256 && pb_membersize(criterion_protocol_submessage, value.assert) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_assert, results) < 256 && pb_membersize(criterion_protocol_submessage, value.birth) < 256 && pb_membersize(criterion_protocol_submessage, value.phase) < 256 && pb_membersize(criterion_protocol_submessage, value.death) < 256 && pb_membersize(criterion_protocol_submessage, value.message) < 256 && pb_membersize(criterion_protocol_submessage, value.assert) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_assert, results) < 256 && pb_membersize(criterion_protocol_submessage, value.birth) < 256 && pb_membersize(criterion_protocol_submessage, value.phase) < 256 && pb_membersize(criterion_protocol_submessage, value.death) < 256 && pb_membersize(criterion_protocol_submessage, value.message) < 256 && pb_membersize(criterion_protocol_submessage, value.assert) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_param_list, list) < 256 && pb_membersize(criterion_protocol_result, value.params) < 256 && pb_membersize(criterion_protocol_assert, results) < 256 && pb_membersize(criterion_protocol_submessage, value.birth) < 256 && pb_membersize(criterion_protocol_submessage, value.phase) < 256 && pb_membersize(criterion_protocol_submessage, value.death) < 256 && pb_membersize(criterion_protocol_submessage, value.message) < 256 && pb_membersize(criterion_protocol_submessage, value.assert) < 256 && pb_membersize(criterion_protocol_msg, data) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_criterion_protocol_birth_criterion_protocol_phase_criterion_protocol_death_criterion_protocol_param_entry_criterion_protocol_param_list_criterion_protocol_result_criterion_protocol_assert_criterion_protocol_log_criterion_protocol_ack_criterion_protocol_submessage_criterion_protocol_msg)
#endif
